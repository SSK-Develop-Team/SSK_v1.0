...
<div class="w3-row">
	...
	<div class="w3-col w3-container s12 m10 l8">
		...
		<!-- 직접평가 이미지 -->
		<div><img id="main-image" src="<%=currLangGameElement.getLangGameImg() %>.jpg" style="width:100%"/></div>
...
// ===== 데이터 =====
	var game_data = [
	  <% for (int j = 0; j < langGameList.size(); j++) { %>
	  {
	    ...
	    speaker: "<%= langGameList.get(j).getLangGameSpeaker().replace("\"", "").replace("\r", "").replace("\n", "") %>",
