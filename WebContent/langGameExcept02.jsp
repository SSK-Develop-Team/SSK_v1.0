...
<div class="w3-row">
	...
	<div class="w3-col w3-container s12 m10 l6">
			...
			<div class="Quiz<%=QuizNum%>" style="height : 100%;width : 100%;position : relative;">
				...
				<% for (int j = 0 ; j < buttonData.size();j++){
						...
						<img class="selectImg0<%=j+1%>" id="Button<%=j+1 %>" 
						 	 ...
						 	 onclick="<%= isCorrect ? "openModal();correctA();" : "wrongA();" %>" />
				<%} %>
				<!-- 모달 -->
				<div id="modal" class="w3-modal">
					<div class="w3-modal-content w3-animate-opacity w3-round-large modal-content">
						<div class="w3-container w3-center">
							<span onclick="closeModal()" class="w3-button w3-display-topright w3-round-xxlarge">&times;</span>
							<img src="<%=currLangGameElement.getLangGameImg() %>_modal.jpg" width="90%" style="margin-top : 5%">
						</div>
					</div>
				</div>
			</div>	
		...
		<div class="w3-left" style="margin-top:5px;">
			...
			<button class="w3-button w3-round-large" onclick="openHint();" style="background-color:#12192C; color:white; text-align:center;font-size:0.9em;margin-right:5px;">
				팁</button>
			...
			<button class="w3-button w3-round-large" onclick="openAnswer();" style="background-color:#12192C; color:white; text-align:center;font-size:0.9em;margin-right:5px;">
				정답 </button>
