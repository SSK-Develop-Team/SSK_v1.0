...
<div class="w3-row"style="height:250px;">
	<div class="w3-panel w3-half w3-row">
		<div class="w3-col s1 m4 l7">&nbsp;</div>
  		<button class="w3-button w3-round-large w3-col s10 m7 l4 target-btn" style="background-color:#FF92A4;color:white;font-size: 1.3em; " onclick = "getSdqTest('PARENT')">부모용 검사  <br> 
  		(3~10세)</button>
  		<div class="w3-col s1 m1 l1">&nbsp;</div>
	</div>
	<div class="w3-panel w3-half w3-row">
		<div class="w3-col s1 m1 l1">&nbsp;</div>
  		<button class="w3-button w3-round-large w3-col s10 m7 l4 target-btn" style="background-color:#FF92A4;color:white;font-size: 1.3em; "onclick = "getSdqTest('CHILD')">아동용 검사 <br> 
  		(11세 이상) </button>
  		<div class="w3-col s1 m4 l7">&nbsp;</div>
	</div>
</div>
