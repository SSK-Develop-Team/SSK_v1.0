...
<div class="w3-row">
	...
	<div class="w3-col s12 m12 l10" style="font-weight:bold;font-size:2.0em;padding-left:1em;"><img src="./image/research.png" style="width:35px;">     아동별 결과 조회</div>
	<div class="w3-col w3-hide-small w3-hide-middle l1">&nbsp;</div>
</div>
...
<div class="w3-row">
	...
	<div class="select-box w3-col s12 m11 l7 w3-padding"style="margin-bottom:0.5em;">
		<div class="w3-row" style="font-weight:bold;font-size:0.9em;margin-left:0.3em; margin-bottom:0.3em;">카테고리<span class="w3-right" style="font-weight:100;font-size:0.9em;">아동과 카테고리를 선택하고 excel export 버튼을 누르세요. 검사 별로 엑셀 파일(.xlsx)이 생성됩니다.</span></div>
		<div class="w3-row w3-padding" style="background-color:#D9D9D9;font-size:1.0em;">
			...
			<div class="w3-col s4 m2 l2">
				<div class="w3-button w3-padding" style="background-color:#51459E; color:white;font-size:1.0em;" onclick="exportData();"> excel export </div>
			</div>
		</div>
	</div>
	<div class="w3-col w3-hide-small w3-hide-middle l1">&nbsp;</div>
