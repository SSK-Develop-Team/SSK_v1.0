...
<div style="width:100%;background-color:#FFDDDD;">
	...
	<div class="w3-center test-main-title"> 정서 반복 기록</div>
	<div class="w3-panel" style="width:100%;height:150px;">
		<div class="w3-hide-small">&nbsp;</div>
		<div class="w3-center test-main-description"><%=name %>(이)의 정서를 관찰할 시간입니다. <br>
...
<div class="w3-row">
	...
	<div class="w3-padding w3-col s10 m6 l4">
		...
		<button class="w3-button w3-block w3-round-large w3-padding-16" 
				...
				onclick="location.href='GetEsmTest?currEsmType=none'">기록하기</button>
		<div>&nbsp;</div> 
		-->
		<button class="w3-button w3-block w3-round-large w3-padding-16 sdq-button" 
				onclick="location.href='esmTargetChoice.jsp'">기록하기</button>
		<div>&nbsp;</div>
		
		<button class="w3-button w3-block w3-round-large w3-padding-16 sdq-button" 
				onclick="location.href='GetEsmTestProfileByTime'">결과 프로파일</button>
	</div>
	<div class="w3-col s1 m3 l4">&nbsp;</div>
</div>
