...
<div class="w3-row" style="margin-top:15vh;">
  ...
  <div class="w3-col s10 w3-center">
	<div class="w3-padding-large">
		...
		<p class="w3-container" style="margin-top: 10px; font-size:18px;color:#FFFFF;"><span style="font-weight:bold;">P</span>arent <span style="font-weight:bold;">S</span>creening of <span style="font-weight:bold;">L</span>anguage and <span style="font-weight:bold;">E</span>motion</p>
