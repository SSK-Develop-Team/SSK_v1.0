...
<div class="w3-row">
	...
	<div class="w3-col s12 m12 l10" style="font-weight:bold;font-size:2.0em;padding-left:1em;"><img src="./image/manage.png" style="width:20px;">     전문가 계정 관리</div>
	<div class="w3-col w3-hide-small w3-hide-middle l1">&nbsp;</div>
</div>
<div class="w3-row">
	<div class="w3-col w3-hide-small w3-hide-middle l1">&nbsp;</div>
	<div class="w3-col s12 m12 l10">
		<div class="w3-row" style="width:100%;margin-bottom:20px;">
			<div class="search w3-right" style="width: 300px;">
				<%if(keyword!=null){ %>
					<input class="w3-border" type="text" id="keyword" value="<%=keyword%>"placeholder="전문가 이름 검색" style="width: 85%;border: 1px solid #bbb;border-radius: 8px;padding: 10px 12px;font-size:1.0em;">
				<%}else{ %>
					<input class="w3-border" type="text" id="keyword" placeholder="전문가 이름 검색" style="width: 85%;border: 1px solid #bbb;border-radius: 8px;padding: 10px 12px;font-size:1.0em;">
				<%} %>
			...
			<div class="buttons" style="width:100%;transform:translateY(0.3em);">
				<button class="w3-button w3-right" style="background-color:#51459E; color:white; font-size:1.0em;margin-right:0.7em;" onclick="deleteExpert()">선택 계정 삭제</button>
				<button class="w3-button w3-right" style="background-color:#51459E; color:white; font-size:1.0em;margin-right:0.7em;" onclick="updateExpert()">선택 계정 수정</button>
				<button class="w3-button w3-right" style="background-color:#51459E; color:white; font-size:1.0em;margin-right:0.7em;" onclick="location.href='register.jsp?role=expert';">전문가 계정 생성</button>
			</div>
		</div>
